...
CREATE TABLE tb_imagem (
    ...
    CONSTRAINT "FK_tb_imagem_tb_produto_ProdutoId" FOREIGN KEY ("ProdutoId") REFERENCES tb_produto (id)
);
...
CREATE TABLE "PromocoesProdutos" (
    ...
    CONSTRAINT "PK_PromocoesProdutos" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_PromocoesProdutos_tb_imagem_ImagemId" FOREIGN KEY ("ImagemId") REFERENCES tb_imagem (id) ON DELETE CASCADE,
    CONSTRAINT "FK_PromocoesProdutos_tb_produto_ProdutoId" FOREIGN KEY ("ProdutoId") REFERENCES tb_produto (id) ON DELETE CASCADE
);
...
CREATE INDEX "IX_PromocoesProdutos_ImagemId" ON "PromocoesProdutos" ("ImagemId");

CREATE INDEX "IX_PromocoesProdutos_ProdutoId" ON "PromocoesProdutos" ("ProdutoId");
...
VALUES ('20230203165808_Init', '7.0.2');
